      ...
      <>
        <h1 className='h1'>Take a look and see what I am working on!</h1>
            <div className='Card1'>
                ...
                <h5 className='card-title'>Calorie and Macros Calculator</h5>
                <p className='card-text'>This app will literally change your life by making the most difficlut part of diet and fitness as easy as using the app.</p>
            ...
            <div className='Card2'>
                <img src='' className='car-image-top' alt=''/>
                <div className='card-body'></div>
                <h5 className='card-title'>Paper Crypto Trading App</h5>
