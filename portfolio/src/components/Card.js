...
const Card = (index) => {
    ...
    return(
        <div className='cards'>
            <card className="card-todo" style={{width: '18rem'}} key={index}>
            ...
            <card className="card-crypto" style={{width: '18rem'}} key={index}>
                <div className="card-body">
            ...
            <card className="card-war" style={{width: '18rem'}} key={index}>
                <div className="card-body">
            ...
            <card className="card-portfolio" style={{width: '18rem'}} key={index}>
                <div className="card-body">
            ...
            <card className="card-concert" style={{width: '18rem'}} key={index}>
                <div className="card-body">
            ...
            <card className="card-macros" style={{width: '18rem'}} key={index}>
                <div className="card-body">
